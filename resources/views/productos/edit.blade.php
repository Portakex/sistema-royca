...
<div class="card card-primary card-outline shadow-sm">
    ...
    <div class="card-body">
        {{-- CAMBIO: Añadir class="editForm" --}}
        <form class="editForm" action="{{ route('productos.update', $producto->id) }}" method="POST">
            @csrf
            @method('PUT') {{-- Sigue siendo necesario para Laravel --}}
            <div class="row g-3">
                {{-- Columna Izquierda --}}
                <div class="col-md-6">
                    <div class="mb-3">
                        <label for="codigo" class="form-label fw-bold">Código del Repuesto</label>
                        <input type="text" class="form-control @error('codigo') is-invalid @enderror" id="codigo" name="codigo" placeholder="Ej: RPT-00123" value="{{ old('codigo', $producto->codigo) }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select id="unidades" name="unidades" class="form-select">
                                <option value="">Seleccione</option>
                                <option value="PZA" @selected(old('unidades', $producto->unidades) == 'PZA')>Pieza</option>
                                <option value="CAJA" @selected(old('unidades', $producto->unidades) == 'CAJA')>Caja</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nombre') is-invalid @enderror" id="nombre" name="nombre" placeholder="Ej: Filtro de aceite" value="{{ old('nombre', $producto->nombre) }}" required>
